...
const clientApp1Path = path.resolve(__dirname, '../user');
const clientApp2Path = path.resolve(__dirname, '../barista');
app.use('/node_modules', express.static(path.join(__dirname, '../node_modules')));
app.use('/assets', express.static(path.join(__dirname, '../barista/assets')));
